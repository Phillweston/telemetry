...
typedef struct __mavlink_rc_channels_override_t
{
 ...
 uint16_t chan11_raw; /*< RC channel 11 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint16_t chan12_raw; /*< RC channel 12 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint16_t chan13_raw; /*< RC channel 13 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint16_t chan14_raw; /*< RC channel 14 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint16_t chan15_raw; /*< RC channel 15 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint16_t chan16_raw; /*< RC channel 16 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint8_t target_system; /*< System ID*/
 uint8_t target_component; /*< Component ID*/
} mavlink_rc_channels_override_t;

#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_LEN 34
#define MAVLINK_MSG_ID_70_LEN 34
