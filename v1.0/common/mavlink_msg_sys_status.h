...
{
	uint16_t oil_consume_current;
	uint16_t engine_speed;
	int16_t cylinder_temp1;
	int16_t cylinder_temp2;
	int16_t cylinder_temp3;
	int16_t cylinder_temp4;
	int16_t exhaust_temp1;
	int16_t exhaust_temp2;
	int16_t exhaust_temp3;
	int16_t exhaust_temp4;
	int16_t intake_temp;
	int8_t thrAngle_offset;
	uint8_t engine_status;
	uint8_t oil_consumption_rate;
	uint8_t oil_lowPress_sp;
	uint8_t oil_lowPress;
	uint8_t oil_railPress_sp;
	uint8_t oil_railPress;
	uint8_t thrAngle;
	uint8_t voltage_sys;
	uint8_t fault_status1;
	uint8_t fault_status2;
	uint8_t fault_status3;
	uint8_t fault_status4;
	uint8_t fault_status5;
	uint8_t fault_status6;
	uint8_t fault_status7;
	uint8_t fault_status8;
	uint8_t health_dev;
	uint8_t health_ins;
...
typedef struct __mavlink_sys_status_t
{
 ...
 uint16_t voltage_battery; /*< Battery voltage, in millivolts (1 = 1 millivolt)*//*临时存放动力电池电压 单位mv*/
 ...
 uint16_t errors_count1; /*< Autopilot-specific errors*//*临时存放飞控电池电压 单位mv*/
 uint16_t errors_count2; /*< Autopilot-specific errors*//*临时存放校准位和状态位*/
